...
from data.REGRAD import REGRAD
...
print(len(data.dataset_dicts) , "data has Done!")

cfg = get_cfg()
cfg.merge_from_file(model_zoo.get_config_file("COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml"))
cfg.DATASETS.TRAIN = ("REGRAD",)
cfg.DATASETS.TEST = ()
...
cfg.MODEL.ROI_HEADS.NUM_CLASSES = len(data.CLASS_NAME) # only has one class (ballon). (see https://detectron2.readthedocs.io/tutorials/datasets.html#update-the-config-for-new-datasets)
